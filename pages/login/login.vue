                    ...
                    <form @submit="formLogin">
                        ...
                        <view class="margin-top-xxxl padding-top-xxxl padding-horizontal-main padding-bottom-main">
                            ...
                            <view class="margin-bottom-xxxl tc">
                                <text v-if="(user || null) == null" class="cr-red round padding-top-xs padding-bottom-xs padding-horizontal-main" data-value="auth" @tap="opt_form_event" @click="customerLogin">使用授权自动登录</text>
